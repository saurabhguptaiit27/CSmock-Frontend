  ...
  return (
    <section class="bg-gradient-to-r from-gray-950 via-gray-900 to-gray-700 w-full h-full">
      <div class="container px-6 py-5 mx-auto">
        ...
        <div class="mt-10 mb-10 xl:mt-12 lg:flex lg:items-center">
          <div class="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
            <div class="space-y-3 p-3 shadow-xl hover:shadow-green-500/10">
              <span class="inline-block p-3 text-blue-700 bg-blue-100 rounded-2xl">
                <svg
